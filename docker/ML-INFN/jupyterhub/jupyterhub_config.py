...
<input list="images" name="img" value="dodasts/ml-infn-lab:v1.0.0-snj">
<datalist id="images">
    <option value="dodasts/ml-infn-lab:v1.0.0-snj">dodasts/ml-infn-lab:v1.0.0-snj</option>
</datalist>
...
class CustomSpawner(dockerspawner.DockerSpawner):
    ...
    def _options_form_default(self):
        ...
        gpu_option = ""
        if use_gpu:
            gpu_option = '<label for="gpu">GPU:</label>\n'
            gpu_option += '<select name="gpu" size="1">\n'
